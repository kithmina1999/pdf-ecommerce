...
import PurchaseRecieptEmail from "@/Email/PurchaseReceipt";
...
export async function POST(req: NextRequest) {
    ...
    if (event.type === 'charge.succeeded') {
        ...
        await resend.emails.send({
            ...
            react: <PurchaseRecieptEmail order={order} product={product} downloadVerificationId={downloadVerification.id} />
        })
